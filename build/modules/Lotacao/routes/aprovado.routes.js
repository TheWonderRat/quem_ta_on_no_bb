...
userRouter.get('/listar-ppp/:candidatos?/:pagina?', (0, celebrate_1.celebrate)({
    [celebrate_1.Segments.QUERY]: {
        //insert server side validation(1 uppercase, 1 number, and so on
        candidatos: celebrate_1.Joi.number().required(),
        pagina: celebrate_1.Joi.number().required(),
...
userRouter.get('/listar-pcd/:candidatos?/:pagina?', (0, celebrate_1.celebrate)({
    [celebrate_1.Segments.QUERY]: {
        //insert server side validation(1 uppercase, 1 number, and so on
        candidatos: celebrate_1.Joi.number().required(),
        pagina: celebrate_1.Joi.number().required(),
...
userRouter.get('/listar-tres/:candidatos?/:pagina?', (0, celebrate_1.celebrate)({
    [celebrate_1.Segments.QUERY]: {
        //insert server side validation(1 uppercase, 1 number, and so on
        candidatos: celebrate_1.Joi.number().required(),
        pagina: celebrate_1.Joi.number().required(),
    },
}), authMiddlewares_1.isAuthenticated, usersController.listarTresParaUm);
userRouter.get('/listar-quatro/:candidatos?/:pagina?', (0, celebrate_1.celebrate)({
    [celebrate_1.Segments.QUERY]: {
        //insert server side validation(1 uppercase, 1 number, and so on
        candidatos: celebrate_1.Joi.number().required(),
        pagina: celebrate_1.Joi.number().required(),
    },
}), authMiddlewares_1.isAuthenticated, usersController.listarQuatroParaUm);
userRouter.get('/listar-convocacao/:candidatos?/:pagina?', (0, celebrate_1.celebrate)({
    [celebrate_1.Segments.PARAMS]: {
        //insert server side validation(1 uppercase, 1 number, and so on
        candidatos: celebrate_1.Joi.number().required(),
        pagina: celebrate_1.Joi.number().required(),
    },
}), authMiddlewares_1.isAuthenticated, usersController.listarConvocacoes);
