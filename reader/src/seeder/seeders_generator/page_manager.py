...
class page_manager:
    ...
    @prev_users.setter
    def prev_users(self, prev_users: str):
        self.__prev_users = prev_users

    @page.setter
    def page(self, rest_of_page: str):
        self.__page = rest_of_page

    @last_record.setter
    def last_record(self, new_last_record):
    ...
    def read_page(self):
        ...
        if region:
            ...
            self.prev_users = self.page
            self.separate_users()
        return self.last_record

    def separate_region(self):
        prev_users, rest_page = regex.split_regions(self.page)
        self.prev_users = prev_users

        self.separate_users()

        self.page = rest_page
        self.last_record = self.region
    ...
    def remove_end(self):
        ...
        self.prev_users = users[0]

    def registre_users(self, user_to_record):
        self.get_file_manager.file_name = self.format_file_name()
