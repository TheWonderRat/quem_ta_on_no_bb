...
async function obterCandidatos(nomeLista, cr) {
  return fs.readFile(nomeLista).then(async (data) => {
    ...
    for (let i = 0; i < arr.length; i += 1) {
      ...
      aprovados.push(gerarCandidato(values, cr));
...
//     }
//   }
//   const correct = lista.reduce((prev, curr) => [prev[1] < curr[0] && prev[0], curr[0]], [true, 0]);

//   if (correct) {
//     return lista;
//   }
//   throw new Error('A lista nao foi corretamente ordenada');
// }
